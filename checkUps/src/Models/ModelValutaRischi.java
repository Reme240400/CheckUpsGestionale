...
public class ModelValutaRischi {
    ...
    public void filterTable(TextField filterTextField, TableView<Reparto> tableView,
            ObservableList<Reparto> observableList) {
        ...
        FilteredList<Reparto> filteredData = new FilteredList<>(observableList, reparto -> {
            ...
            return reparto.getNome().toLowerCase().startsWith(filterText);
        });
